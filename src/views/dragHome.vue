<template>
  <div id="darag" style="height: 100%">
    ...
    <section ref="main" class="main">
      ...
      <!--      </div>-->
      <div class="view-content" @dragover="dragOver"
           @drop="drog">
...
export default {
  ...
  data() {
    return {
      ...
      dragList: [],
      getDragId: '',
      dragId: window.sessionStorage.getItem('dragId') ? window.sessionStorage.getItem('dragId') : 'PL22090068'
    }
  },
  created() {
    this.loading()
      ...
      if (this.dragId) {
        ...
        for (const index in dragList) {
          ...
          if (dragList[index].top != 0) {
            tempItem.subList = this.buildSubList(dragList[index], index, dragList)
