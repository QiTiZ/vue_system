<template>
  <div :style="{fontSize: size,textAlign: align ,marginTop:top}" class="text">
    <div :style="{left:left}" class="cc">
      {{ list.val || "一行多列" }}
    </div>
    <div :style="{left:left1}" class="cc">
      {{ list.val1 }}
    </div>
    <div :style="{left:left2}" class="cc">
      {{ list.val2 }}
    </div>
    <div :style="{left:left3}" class="cc">
      {{ list.val3 }}
    </div>
    <div :style="{left:left4}" class="cc">
      {{ list.val4 }}
    </div>
    <div :style="{left:left5}" class="cc">
      {{ list.val5 }}
    </div>
  </div>
</template>
